...
public class PickedupListActivity extends AppCompatActivity {
      ...
      listView1.setAdapter(adapter); /*
        ...
        listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                ...
                Intent intent = new Intent(PickedupListActivityextends.this,RequestStatus.class);
                intent.putExtra("R_id", weatherList.get(position).R_id);
